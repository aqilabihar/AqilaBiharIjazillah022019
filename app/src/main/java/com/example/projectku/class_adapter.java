...
public class class_adapter extends RecyclerView.Adapter<class_adapter.DatakuViewHolder>  {
    ...
    public class_adapter(ArrayList<Model> dataList, Callback callback) {
    ...
    public class DatakuViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener{
        ...
        public DatakuViewHolder(View itemView) {
            super(itemView);
            viewku=itemView;
            card = (CardView) itemView.findViewById(R.id.cardnya);
            ivprofile = (ImageView) itemView.findViewById(R.id.Gambar);
            txtNama = (TextView) itemView.findViewById(R.id.TVjudul);
